...
const AboutPage = () => {
  ...
  const handleNavigation = (e: React.MouseEvent<HTMLButtonElement, MouseEvent>) => {
    e.preventDefault();
    router.push('/'); // Step 1: Navigate to Home

    setTimeout(() => {
      const section = document.getElementById('personalize');
      if (section) {
        section.scrollIntoView({ behavior: 'instant' }); // Step 2: Instantly jump to section
      }
      ...
      <div className="w-full    relative flex flex-col items-center justify-center text-center">
        ...
        <div className="text-white flex flex-col items-center justify-center px-4 md:px-0 py-12">
          <div className="relative flex items-center justify-center w-full h-[300px] md:h-[400px]">
            ...
            {/* Heading */}
            <h1 className="text-4xl md:text-6xl font-bold text-white relative z-10">About Us</h1>
          </div>
          <p className="text-base md:text-lg max-w-full md:max-w-[75%] leading-relaxed mt-6">
            Our vision is to shape the future by climbing the ladder towards Artificial General Intelligence (AGI). With
            a firm foundation in cutting-edge AI research, we have developed an in-house multilingual Large Language
            Model (LLM) that caters to multiple Indic languages, setting a new benchmark in language technology. Built
            on this foundation of our in-house LLM, we introduced AnyVoice, a revolutionary AI phone caller that
            automates thousands of inbound and outbound calls.
          </p>
        </div>
        ...
        <div className="text-white flex flex-col items-center justify-center px-4 md:px-0 py-12">
          ...
          <p className="text-base md:text-lg max-w-full md:max-w-[75%] leading-relaxed mt-12">
            With AnyVoice, businesses can automate their operations by employing an intelligent Agent that is capable of
            handling inbound/outbound calls with human-like natural sounding voice quality that can support multiple
            dialects and accents in different languages. Backed by our custom LLM, businesses can use AnyVoice at a very
            effective and efficient cost to automate thousands of calls that can be tailored to their specific domain.
          </p>
          <button
        ...
        <div className="text-white flex flex-col items-center justify-center px-4 md:px-0 py-12">
          ...
          <p className="text-base md:text-lg max-w-full md:max-w-[75%] leading-relaxed mt-12">
            Neurify`s core team comprises skilled individuals having expertise in their specific domain. Their vision
            combined with their expertise is helping Neurify in realizing it’s vision.
          </p>
            ...
            {People.map((i, index) => (
              ...
              >
                ...
                <div className="w-[150px] h-[150px] rounded-full overflow-hidden mb-4 flex items-center justify-center">
                  <Image src={i.imageURI} alt="Profile Picture" width={150} height={150} className="object-cover" />
                </div>
                ...
                {/* Role */}
                <p className="text-sm mt-2 border border-[#333333] text-white px-3 py-1 rounded-full">
                ...
                <div className="flex mt-4 space-x-3">
                  {/* Twitter Button */}
                  <button className="w-10 h-10 flex items-center justify-center rounded-full shadow-md hover:opacity-90 transition duration-300">
                    <Image src="/Button-twitter.png" alt="Twitter" width={40} height={40} />
                  </button>

                  {/* LinkedIn Button */}
                  <button className="w-10 h-10 flex items-center justify-center rounded-full shadow-md hover:opacity-90 transition duration-300">
                    <Image src="/Button-linkedin.png" alt="LinkedIn" width={40} height={40} />
                  </button>
                </div>
              </div>
            ))}
